...
#---------------- 1. Salario por hora del trabajador dependiente --------------------

# Se creará el ingreso y gasto real per cápita mensual del hogar para los años 2019 y 2020. 
# Para ello, primero se realizará un merge ente le Módulo 1 (características de la vivienda y 
# el hogar) y Módulo 34 (sumaria) para cada año. Luego, se realizará un append que permitirá 
# juntar ambas base de datos.
...
# Haciendo uso de la base de datos, se calculará el salario por hora del trabajador dependiente.
...
Primero, se aplicará groupby para luego realizar un merge con el Modulo 34. Finalmente, se creará la variable dummy.
